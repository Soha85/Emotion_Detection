...
class TweetCNN(nn.Module):
    def __init__(self, embed_dim, num_classes):
        ...
        self.conv2 = nn.Conv1d(in_channels=128, out_channels=64, kernel_size=5, padding=1)
        self.pool2 = nn.MaxPool1d(kernel_size=3, stride=2)

        # Adjusted fully connected layer input size to match flattened size
        self.fc = nn.Linear(64 * 191, num_classes)  # Output size matches number of classes (11)
